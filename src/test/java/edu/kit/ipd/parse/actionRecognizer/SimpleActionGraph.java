...
public class SimpleActionGraph {
    ...
    public SimpleActionGraph() {
        this.nodes = new LinkedList<SimpleActionNode>();
        this.arcs = new LinkedList<SimpleActionArc>();
    }
...
//    }
    ...
    public void addsRolesWithSolution(String text) {
        ...
        for (String nrValueRole : nrValueRoles) {
            ...
            this.addNode(new SimpleActionNode(value, role, position));
        }
    ...
    public void addsArcsWithSolution(String text) {
        ...
        for (String nodeNodeType : nodeNodeTypes) {
            ...
            this.addArc(new SimpleActionArc(this.getNodes().get(Integer.parseInt(sourceNodeNr)),
                    this.getNodes().get(Integer.parseInt(targetNodeNr)), arcType));
